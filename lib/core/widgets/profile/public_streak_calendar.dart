...
class PublicStreakCalendar extends StatefulWidget {
  final String uid;
  const PublicStreakCalendar({super.key, required this.uid});

  @override
  State<PublicStreakCalendar> createState() => _PublicStreakCalendarState();
}

class _PublicStreakCalendarState extends State<PublicStreakCalendar> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: _publicUserService.getActivityStream(widget.uid),
